...
<div>
    <form id="addStuForm" action="../handlerPage/editStuHandler.php" method="post" align="center" onsubmit="return checkStuInfo()">
        <input type="text" name="stu_id" hidden="hidden" value="<?php echo $_GET['stu_id'];?>">
